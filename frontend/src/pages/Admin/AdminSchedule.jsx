...
import { Button, Input, Table, Space, Divider, Steps } from "antd";
...
export default function AdminSchedule() {
  ...
  const columns = [
    ...
    },
    {
      ...
      width: "",
      render: e => (
        <Steps current={current} onChange={onChanger}>
          <Step title="Đang giao hàng" description="" />
          <Step title="Đang đên kho thành phố Hồ Chí Minh" description="" />
          <Step title="Đang đến kho Hà Nội" description="" />
          <Step title="Shipper đã lấy hàng" description="" />
          <Step title="Người gửi đang chuẩn bị hàng" description="" />
        </Steps>
      )
    },
    // {
